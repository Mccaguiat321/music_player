...
@Component({
  selector: 'app-rapping',
  templateUrl: './rapping.component.html',
  styleUrl: './rapping.component.css'
})
export class RappingComponent {
   songs = [
    { title: "Lose Yourself", artist: "Eminem", url: "assets/Eminem_-_Lose_Yourself(256k).mp3", duration: 0 },
    { title: "God's Plan", artist: "Drake", url: "assets/God_s_Plan(256k).mp3", duration: 0 },
    { title: "SICKO MODE", artist: "Travis Scott", url: "assets/Travis_Scott_-_SICKO_MODE_ft._Drake(256k).mp3", duration: 0 }
  ];
